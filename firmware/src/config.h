...
#define I2S_SPEAKER_LEFT_RIGHT_CLOCK GPIO_NUM_14  // LRC
#define I2S_SPEAKER_SERIAL_DATA GPIO_NUM_26 // DIN
...
#define COMMAND_RECOGNITION_ACCESS_KEY "ZR2MAIYMQMPYFFCVT2FO2OYQYNTA5ANF"
